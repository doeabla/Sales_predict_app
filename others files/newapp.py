...
st.markdown(
    ...
    f'<h2>SALES PREDICTION</h2>'
    f'<p>Optimize business strategies using accurate sales forecasts. Predict trends, plan inventory, and elevate decision-making.</p>'
    f'</div>',
...
with display_column:
    st.markdown(
        ...
        f'<h2>Predictions</h2>'
        f'<div style="color: {"green" if predictions > 1000000 else "red"}; font-size: 24px;">{predictions}</div>'
        f'</div>',
        unsafe_allow_html=True)
